...
export const E_TRANSACTION_NOT_FOUND =
  'User not found! Please make sure the transaction ID entered is valid!'
export const E_UNAUTHORIZED_ACCESS_TO_RESOURCE =
  'You are now allowed to access this resource!'
